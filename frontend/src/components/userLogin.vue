            ...
            <form class="mt-8 space-y-6" @submit.prevent="signIn">
                ...
                <div class="-space-y-px rounded-md shadow-sm">
                    <div>
                        ...
                        <input id="inputUsername" name="inputUsername" type="text" v-model="inputUsername" required
                            class="relative block w-full appearance-none rounded-none rounded-t-md border border-gray-300 px-3 py-2 text-gray-900 placeholder-gray-500 focus:z-10 focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm"
                            placeholder="Username" />
                    </div>
                    <div>
                        <label for="password" class="sr-only">Password</label>
                        <input id="inputPassphrase" name="inputPassphrase" type="password" v-model="inputPassphrase"
                            required
