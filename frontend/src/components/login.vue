                ...
                <form class="" @submit.prevent="handleSubmitForm">
                    <div class="mb-4">
                        ...
                        <input
                            ...
                            id="username" type="email" placeholder="Email" v-model="event.email">
                        <span class="text-black" v-if="v$.event.email.$error">
                            <p class="text-red-700" v-for="error of v$.event.email.$errors" :key="error.$uid">
                                {{ error.$message }}!
                            </p>
                        </span>
                    </div>
                    <div class="mb-6">
                        ...
                        <input
                            class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                            id="password" type="password" placeholder="password" v-model="event.password">
                        <span class="text-black" v-if="v$.event.password.$error">
                            <p class="text-red-700" v-for="error of v$.event.password.$errors" :key="error.$uid">
                                {{ error.$message }}!
                            </p>
                        </span>
                    </div>
